...
<?php endif; ?>
        ...
        <div class="mt-0.5 grid flex-1">
            <!--[if BLOCK]><![endif]--><?php if(filled($title = $getTitle())): ?>
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if(filled($date = $getDate())): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-notifications::components.date','data' => ['class' => 'mt-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if(filled($body = $getBody())): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-notifications::components.body','data' => ['class' => 'mt-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-notifications::components.actions','data' => ['actions' => $actions,'class' => 'mt-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-notifications::components.close-button','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\zoikotelecom_backend_filament_admin\vendor\filament\notifications\src\/../resources/views/notification.blade.php ENDPATH**/ ?>