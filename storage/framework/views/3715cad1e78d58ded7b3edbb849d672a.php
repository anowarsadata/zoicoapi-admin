...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['color','disabled','form','href','icon','iconSize','keyBindings','labelSrOnly','tag','target','tooltip','type','wire:click','wire:target','xOn:click','class','badge','badgeColor','iconPosition','labeledFrom','outlined','size','badgeColor','iconPosition','labeledFrom']));
...
foreach (array_filter((['color','disabled','form','href','icon','iconSize','keyBindings','labelSrOnly','tag','target','tooltip','type','wire:click','wire:target','xOn:click','class','badge','badgeColor','iconPosition','labeledFrom','outlined','size','badgeColor','iconPosition','labeledFrom']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\zoikotelecom_backend_filament_admin\storage\framework\views/434620315b415d2a91f23836155ff354.blade.php ENDPATH**/ ?>