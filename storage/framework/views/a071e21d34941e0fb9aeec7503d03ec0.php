...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-panels::components.form.index','data' => ['wire:key' => $this->getId() . '.forms.' . $this->getFormStatePath(),'wire:submit' => 'save']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\zoikotelecom_backend_filament_admin\vendor\filament\filament\src\/../resources/views/resources/pages/edit-record.blade.php ENDPATH**/ ?>