...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['color','disabled','form','href','icon','iconSize','keyBindings','labelSrOnly','tag','target','tooltip','type','wire:click','wire:target','xOn:click','class','xBind:disabled','badge','badgeColor','iconPosition','labeledFrom','outlined','size','badgeColor','iconPosition','labeledFrom']));
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\zoikotelecom_backend_filament_admin\storage\framework\views/dad8345c7702ce2c5d9aafc006f30f01.blade.php ENDPATH**/ ?>